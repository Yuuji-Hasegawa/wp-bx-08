...
<div class="o-switcher o-switcher--no-gap js-pull-view">
  <div class="o-cover u-bg-invert c-inner-box u-pb-2xl u-pt-xl">
    <h2 class="c-sec-heading u-text-center u-font-en-con u-text-weight-b js-fade-up">Reserve</h2>
    <div class="o-cover__middle u-content-wrap u-block-center js-fade-up">
      ご来店予約は、各店舗まで。<br />
      各店舗のお問い合わせ先は、店舗情報をご確認ください。
    </div>
  ...
  <div class="o-cover u-bg-primary c-inner-box u-pb-2xl u-pt-xl">
    <h2 class="c-sec-heading u-text-center u-font-en-con u-text-weight-b js-fade-up">Inquiry</h2>
    <div class="o-cover__middle u-content-wrap u-block-center js-fade-up">
